...
def main():
    ...
    parser.add_argument('--prompt_template', type=str, default="ENEXA_Demo2/input_files/prompt_template_with_example.json", help='The prompt template to fill in the inputs.')
